...
import {
  useFetchPtbAggregatedBalance,
  useFetchUbaAggregatedBalance,
  useFetchZenithAggregatedBalance,
} from "@/api/query";
...
export default function ZenithBankPage() {
  ...
  const {
    ...
    error,
    refetch,
  } = useFetchZenithAggregatedBalance({ page, size, search });
  ...
  return (
    ...
    "
          ...
          <button
            className="sm:w-fit w-full  flex items-center justify-center mt-2 gap-2 px-4 py-2 rounded-xl text-sm font-bold transition-all hover:opacity-80"
            style={{
