...
function TransactionsContent() {
  ...
  const totalCredit = data.reduce(
    (s, tx) => s + parseFloat(tx.CreditAmt || "0"),
    0,
  );
  const totalDebit = data.reduce(
    (s, tx) => s + parseFloat(tx.DebitAmt || "0"),
    0,
  );
  ...
  const stats = [
    {
      ...
      value: formatCurrency(latestBalance, currency),
      badge: currency,
      badgeColor: "#13ec5b",
    ...
    },
    {
      ...
      badge: `-${debitCount}`,
      badgeColor: "#ef4444",
      sub: "Outflow this period",
      Icon: TrendingDown,
    },
    {
      label: "Transactions",
      value: (
        fetchStatement?.meta?.totalResults ?? data.length
      ).toLocaleString(),
      badge: "Total",
      badgeColor: "#60a5fa",
      sub: "All records",
        ...
        <div className="p-4 sm:p-6 lg:p-8">
          ...
          >
            ...
            <div className="flex items-center justify-between sm:justify-start sm:gap-3 w-full sm:w-auto sm:ml-auto">
              ...
              <span
                className="text-sm ml-3 sm:ml-0"
                style={{ color: "rgba(255,255,255,0.4)" }}
              >
                ...
                <thead>
                  ...
                  >
                    {[
                      ...
                      <th
                        key={h}
                        className="px-4 sm:px-5 py-3 sm:py-4 whitespace-nowrap"
                        style={{
                  ...
                  {isLoading ? (
                    ...
                    data.map((tx, i) => (
                      ...
                      >
                        ...
                        <td
                          className="px-4 sm:px-5 py-3 sm:py-4 font-mono text-xs whitespace-nowrap"
                        ...
                        <td className="px-4 sm:px-5 py-3 sm:py-4">
                          <div className="flex items-center gap-2 sm:gap-3">
                            ...
                            <div>
                              <p className="text-sm font-semibold text-white leading-tight max-w-[120px] sm:max-w-[160px] truncate">
                                {tx.AcctName}
                              </p>
                              <p
                        ...
                        <td className="px-4 sm:px-5 py-3 sm:py-4">
                          <span
                            ...
                            style={{
                              backgroundColor: modeColor(tx.Mode) + "18",
                              color: modeColor(tx.Mode),
                              border: `1px solid ${modeColor(tx.Mode)}33`,
                            }}
                          >
                            {tx.Mode}
                          </span>
                        ...
                        <td
                          className="px-4 sm:px-5 py-3 sm:py-4 text-right text-sm font-bold whitespace-nowrap"
                          style={{ color: "#13ec5b" }}
                        >
                          {parseFloat(tx.CreditAmt) > 0
                            ? `+${tx.CreditAmtFormatted}`
                            : "—"}
                        </td>
            ...
            >
              ...
              >
                ...
                <span className="text-white font-bold">
                  {fetchStatement?.meta?.totalPages ?? 1}
                </span>
                <span
              ...
              <div className="flex justify-center sm:justify-end">
                <Pagination
                  page={page}
                  totalPages={fetchStatement?.meta?.totalPages ?? 1}
